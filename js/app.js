...
var FormHelper, IStorage, ListHelper, NotifyHelper, QList, QLocalStorage, QManager, QRelation, QValidation,
...
QLocalStorage = (function(_super) {
  ...
  QLocalStorage.prototype.set = function(key, val) {
    ...
    try {
      ...
      e = _error;
      NotifyHelper.prototype.Danger("Превышен лимит использования памяти localStorage");
    }
    return null;
  };
...
QManager = (function() {
  ...
  QManager.prototype.Create = function(json) {
    ...
    if (this.Validation(json) === true) {
      if (__id = this.relation.newRow()) {
        ...
        NotifyHelper.prototype.Info("Добавлена новая книга");
        return __id;
      }
    }
    return false;
  ...
  QManager.prototype.Update = function(__id, json) {
    ...
    if (row = this.Read(__id)) {
      if (this.Validation(json, 'update') === true) {
        this.storage.set(__id, json);
        NotifyHelper.prototype.Info("Обновлено");
        return true;
      }
    }
    return false;
  ...
  QManager.prototype.Delete = function(__id) {
    ...
    if (this.relation.findById(__id) === true && (row = this.Read(__id))) {
      if (this.relation.remove(__id) === true) {
        ...
        NotifyHelper.prototype.Info("Книга была удалена");
        return true;
      }
      return false;
    }
  ...
  QManager.prototype.Validation = function(json, scenario) {
    ...
    try {
      ...
      e = _error;
      NotifyHelper.prototype.Danger(e);
      return false;
    }
  };
...
$(function() {
  ...
  buttons = function() {
    var MIN_WIDTH;
    MIN_WIDTH = 600;
    if ($(document).width() <= MIN_WIDTH * 2 * ($('aside').position().left !== 0)) {
